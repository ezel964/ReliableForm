...
<div class="page-head">
  ...
  <a class="btn btn-ghost" href="/forms/<?= (int) $submission['form_id'] ?>/submissions">&larr; All submissions</a>
</div>
          ...
          <dd>
            ...
            <?php elseif ($type === 'rating'): ?>
              ...
              <?php if ($v === ''): ?>
                <span class="muted">— no answer —</span>
              <?php else: ?>
                <span class="rating-answer"><?= e($v) ?> / <?= (int) ($field['max'] ?? 5) ?> <span class="star-glyph">★</span></span>
              <?php endif; ?>
  ...
  <div class="detail-side">
    <div class="card">
      ...
      <div class="job-row">
        ...
        <?php else: ?>
          <a class="btn btn-ghost btn-small" href="/submissions/<?= (int) $submission['id'] ?>/pdf">Check progress</a>
        <?php endif; ?>
      </div>
      ...
      <div class="job-row">
        ...
        <?php if ($emailRow !== null): ?>
          <span class="muted small">to <?= e((string) $emailRow['to_email']) ?></span>
        <?php endif; ?>
      </div>
    ...
    <div class="card">
      <h2>Meta</h2>
      <dl class="meta-list">
        <div><dt>Submitted</dt><dd><?= e((string) $submission['created_at']) ?> UTC</dd></div>
        <div><dt>IP</dt><dd><?= e((string) ($submission['ip'] ?? '—')) ?></dd></div>
